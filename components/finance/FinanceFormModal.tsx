...
export default function FinanceFormModal({ isOpen, onClose, locale }: Props) {
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        // garante que o locale chega no server action
        ...
        // força a rota a refazer o fetch no servidor
        startTransition(() => {
            router.refresh();
        });
                ...
                <form action={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex bg-gray-100 p-1 rounded-xl">
                        <button
                            ...
                            className={`flex-1 py-2 rounded-lg text-sm font-semibold transition ${type === "income"
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 rounded-lg text-sm font-semibold transition ${type === "expense"
                    ...
                    <button
                        ...
                        className={`mt-4 w-full py-4 text-white font-bold rounded-xl transition shadow-lg ${type === "income"
